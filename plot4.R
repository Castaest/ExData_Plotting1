...
plot(alldata$Date, alldata$Global_active_power, type = 'l', xlab = '', ylab = 'Global Active Power')
...
plot(alldata$Date, alldata$Voltage, type = 'l', xlab = 'datetime', ylab = 'Voltage')

plot(alldata$Date, alldata$Global_reactive_power, type = 'l', xlab = 'datetime', ylab = 'Global_reactive_power')
